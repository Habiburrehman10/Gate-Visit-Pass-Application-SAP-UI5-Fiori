		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#gatepassgatepass-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"gatepassgatepass-display": {
								"semanticObject": "gatepassgatepass",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=gatepass.gatepass",
									"url": sap.ui.require.toUrl("gatepass/gatepass")
								}
							}
						}
					}
