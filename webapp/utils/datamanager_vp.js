sap.ui.define([
	...
	return {
		...
		getLoc: function( successCallback, errorCallback){
			...
			var sPath = "et_item_dataSet(IvCall='L',IvKey='" + itemData.IvKey + "',IvNumber='" + itemData.IvNumber + "')";
		...
		getVPDetails: function(object, successCallback, errorCallback){
		...
		deleteData: function(oObject,successCallback, errorCallback){
            ...
            //var sPath = "/sap/opu/odata/sap/ZCDS_ODATA_SRV/CreateSet";
			var sPath = "et_gatepass_createSet(IvCall='D',IvKey='VP',IvNumber='" + dataToPost1.IvNumber + "')";
		...
		getVPReport: function(successCallback, errorCallback){
